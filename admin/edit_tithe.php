...
$sql = "SELECT * FROM tithe INNER JOIN members ON  tithe.mobile = members.phonenumber WHERE titheid = $id";
...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="form-container">
            ...
            <form method="post" action="update_tithe.php">
                            <input type="hidden" name="id" value="<?php echo $row['titheid']; ?>">
                    ...
                    <button type="submit" name="update_tithe" class="save-btn">Save Changes</button>
            </form>
            </div>
    </section>
