...
$column = '*';
$jointable= 'members';
$joincondition='tithe.mobile = members.phonenumber';
    ...
    <nav>
     ...
     <section class="dashboard">
        ...
        <label  for="tithe">Tithe</label>
            ...
            <form action="add_tithe.php"><button class="add-data-button">Add Data</button></form>
            ...
            <table>
                ...
                <?php foreach($result as $row){
                    ...
                    <tr>
                        ...
                        <td>
                             <a href="edit_tithe.php?id=<?php echo $row['titheid']; ?>" class="btn btn-success">Update</a>
                             <form id="deleteform" action="delete_tithe.php"  class="d-inline" method="post">
