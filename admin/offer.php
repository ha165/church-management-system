...
<body>
    ...
    <section class="dashboard">
        ...
        <label  for="tithe">Offering Details</label>
            <div class="button-container">
                <form action="add_offering.php"><button class="add-data-button">Add Data</button></form>
            ...
            <table>
                ...
                <?php foreach($result as $row){
                    ...
                    <tr>
                        ...
                        <td>
                             <a href="edit_offering.php?id=<?php echo $row['offerid']; ?>" class="btn btn-success">Update</a>
                             <form action="delete_offering.php"  class="d-inline" method="post">
