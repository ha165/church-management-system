...
$result = selectdata('members','*','','',"gender='female'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <?php 
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit_member.php?id=<?php echo $row['ID_Number']; ?>" class="btn btn-success">Update</a>
                                    <form action="member_delete.php"  class="d-inline" method="post">
