...
$column = '*';
$jointable= 'members';
$joincondition='offering.mobile = members.phonenumber';
$where = "offerid = $id";

$result = selectdata($table,$column,$jointable,$joincondition,$where);
...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="form-container">
            ...
            <form method="post" action="update_offering.php">
                            <input type="hidden" name="id" value="<?php echo $row['offerid']; ?>">
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="name" value="<?php echo $row['firstname']; ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Transaction Code</label>
                        <input type="text" name="trcode" value="<?php echo $row['trcode']; ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Amount</label>
                    ...
                    <div class="form-group">
                        <label>Date</label>
                        <input type="text" name="paytime" value="<?php echo $row['paytime']; ?>" class="form-control">
                    </div>
                    <button type="submit" name="update_offering" class="save-btn">Save Changes</button>
            </form>
            </div>
    </section>
