...
$pdf->MultiCell(40,10,'Date',1);

$pdf->Ln();

$stmt = $mysqli->prepare("SELECT * FROM tithe INNER JOIN members ON tithe.mobile = members.phonenumber WHERE mobile=?");
